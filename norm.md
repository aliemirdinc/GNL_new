...
General example:
intg_global;
typedef structs_struct
## {
char*my_string;
inti;
## }t_struct;
structs_other_struct;
intmain(void)
## {
inti;
charc;
...
intmy_func(intarg1,chararg2,char*arg3)
## {
return(my_val);
## }
intfunc2(void)
...
•The$(NAME),clean,fclean,reandallrules are mandatory. Theallrule must be
